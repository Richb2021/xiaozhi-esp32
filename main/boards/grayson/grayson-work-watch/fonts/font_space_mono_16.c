 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font SpaceMono-Regular.ttf --size 16 --bpp 4 --format lvgl --range 0x20-0x7E --no-compress -o lvgl/font_space_mono_16.c
 ******************************************************************************/

#include <lvgl.h>

#ifndef FONT_SPACE_MONO_16
#define FONT_SPACE_MONO_16 1
#endif

#if FONT_SPACE_MONO_16
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_space_mono_16 = {
#else
lv_font_t font_space_mono_16 = {
#endif
